...
public class Client extends Personne {
    ...
    public Client(Long id, String nom, String prenom, String matricule, String username,
        ...
        super(id, nom, prenom, matricule, username, motDePasse, email, telephone, resetToken, etatCompte,
                estCertifie, autorisation, role);
        this.id = id1;
    }
