...
import com.memoire.apiAhoewo.service.gestionDesLocationsEtVentes.DemandeAchatService;
...
public class ContratVenteServiceImpl implements ContratVenteService {
    ...
    @Override
    public byte[] generateContratVentePdf(Long id) throws MalformedURLException {
        ContratVente contratVente = contratVenteRepository.findById(id).orElse(null);
        ...
        table.addCell(new Cell().add(new Paragraph("Contrat de vente")).setFontSize(14f).setBorder(Border.NO_BORDER).setBold());
